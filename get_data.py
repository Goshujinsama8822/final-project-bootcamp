    ...
    if page['href'] == "climas.html" or page['href'] == "hidros.html" or page['href'] == "presas.html":
        ...
        for npage in newPages:
            ...
            if str(npage['href'][-4:]) == ".csv":
                ...
                if i == 0:
                    mData = pd.DataFrame()
                    mData = pd.read_csv(durl.replace(" ", "%20"), encoding = "ISO-8859-1")
                    ...
                    data = pd.DataFrame()
                    data = pd.read_csv(durl.replace(" ", "%20"), encoding="utf8", header = 6)
